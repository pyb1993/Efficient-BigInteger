...
public:
	...
	friend void shift_left(const BigInteger& lhs, BigInteger& ret, size_t num);
	friend void shift_right(const BigInteger& lhs, BigInteger& ret, size_t num);
	...
	BigInteger truncate_mul(const BigInteger&);
...
void shift_left(const BigInteger& lhs, BigInteger& ret, size_t num);
void shift_right(const BigInteger& lhs, BigInteger& ret, size_t num);
